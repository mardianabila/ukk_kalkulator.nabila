...
<html lang="id">
    ...
    <body> 
                ...
                <div class="col-md-4">
                    <form method="POST" class="p-2 border rounded bg-light">
                        ...
                        <div class="d-flex justify-content-center gap-2 mt-2">
                            ...
                            <button type="reset" class="btn btn-primary" title="Clear Entry">CE</button>
                        </div>
                    </form> 
                    <div class="p-1 border rounded bg-light">
                        ...
                        <div class="row mt-2">
                            <div class="col-6 text-end">
                                <form method="POST">
                                    <button type="submit" name="memory" class="btn btn-danger" title="Memory Entry">ME</button>
                                </form>
                            </div>
        ...
        <p class="text-center">&copy; UKK RPL 2025 | Nabila Fatasari | XII PPLG</p>
